          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Thêm Tài Nguyên<small></small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" action="save_nguyenlieu" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="donvi" id="donvi" class="form-control" id="">
                  </div>
